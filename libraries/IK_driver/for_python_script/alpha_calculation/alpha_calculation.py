...
class Alpha():
    ...
    def compute_Alpha_v3(self, xt,yt,zt,x,y,z,w, sizes, limAlpha):
        ...
        for i in range(10):
            if (testalpha6[i]>0 and testalpha6[i+1]<0)or(testalpha6[i]<0 and testalpha6[i+1]>0): 
                points.append(i)
                #print(i)
        k=0
        if len(points)==0:
        ...
        for i in range (len(alpha6m)):
            ...
            if limAlpha10[0] < alpha10*1698 and alpha10*1698<limAlpha10[1]:
                alpha10m.append(alpha10)
            else:
                alpha6m.pop(i-kk)
                kk=kk+1
        #print(alpha6m)
...
test1 = [(-0.004051742, 0.6182534, -1.218165, -0.5999113, -0.004051742, 0)]
test2 = [(-0.4625484, 1.483579, -1.459845, -0.3856074, 0.1495111, 0.1), (-0.4625484, -0.008424724, -1.503286, -1.921052, 0.1495111, 0.1)]
alpha = Alpha()
start_time = time.time()
angles1 = alpha.compute_Alpha_v3(-41.25 , -80.0 , -148.0 , 0.04 , -0.0 , -1 , 0.0, sizes, limAlpha)
angles2 = alpha.compute_Alpha_v3(-26.25 , -80.0 , -148.0 , 0.04 , -0.0 , -1 , 0.0, sizes, limAlpha)
print("--- %s seconds ---" % (time.time() - start_time))

print('angles1 = ', angles1)
print('angles2 = ', angles2)
#print('angles2 = ', angles2)
#print('myangles = ', myangles)
print(' ')
print('----------------------my_function----------------------------')
start = time.time()
myangles1 = starkit.starkit_alpha_calculation(-41.25 , -80.0 , -148.0 , 0.04 , -0.0 , -1 , 0.0, sizes, limAlpha)
myangles2 = starkit.starkit_alpha_calculation(-26.25 , -80.0 , -148.0 , 0.04 , -0.0 , -1 , 0.0, sizes, limAlpha)
end = time.time()
print("--- %s seconds ---" % (end - start))
print('myangles1 = ', myangles1)
print('myangles2 = ', myangles2)
print(' ')